        ...
        if ($request->isMethod('POST')) {
            ...
            $this->validate(
                ...
                [
                    ...
                    'Users.account' => 'required|integer',
                    'Users.phone' => 'required|integer',
                ],
                [
                    //翻译
                    'required' => ':attribute 为必填项',
        ...
        if ($request->isMethod('get')) {
            ...
            if (!empty($request)) {
                ...
                if (!empty($users['data'])) {
                    ...
                    // dd($num);
                    // 从数据库获得对应数据
                    $userss = Users::where('name', $num)->orWhere('name','like','%'.$num.'%')
                        ->first();
                    // dd($userss);
                    ...
                    if (!empty($userss)) {
                        // dd($userss);
                        // 分页
                        $userss = Users::where('name',$num)->orWhere('name','like','%'.$num.'%')->paginate(10);
                        return view('users/index', [
                            'userss' => $userss,
                        ]);
                    } else {
